...
//    public static final String COORDENADA_URL = "https://t-organizagroup.com/ws_easyhotel/public/api/";
    public static final String NEW_TEST_URL = "https://easyhotel.pe:1337/";
//    public static final String NEW_TEST_URL = "http://104.130.217.167:1337/";
    ...
    public static Ubigeo getFilter(){
        return ubigeoCliente.getUbigeoData (NEW_TEST_URL).create (Ubigeo.class);
    }
